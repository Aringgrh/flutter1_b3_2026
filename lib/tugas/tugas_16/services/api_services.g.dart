...
class _ApiService implements ApiService {
  ...
  Future<ProfilePhotoResponse> editProfilePhoto(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<ProfilePhotoResponse>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/profile/photo',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProfilePhotoResponse _value;
    try {
      _value = ProfilePhotoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<TrainingListResponse> getTrainings() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TrainingListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/trainings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TrainingListResponse _value;
    try {
      _value = TrainingListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<BatchListResponse> getBatches({String? token}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': token};
